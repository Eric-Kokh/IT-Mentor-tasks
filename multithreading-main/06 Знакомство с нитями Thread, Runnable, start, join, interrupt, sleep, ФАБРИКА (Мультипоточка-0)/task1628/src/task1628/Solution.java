...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(consoleReader1.getName() + consoleReader1);
        System.out.println(consoleReader2.getName() + consoleReader2);
        System.out.println(consoleReader3.getName() + consoleReader3);
